      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white py-12 px-6 sm:px-10 lg:px-16 rounded-xl shadow-xl border-t-4 border-indigo-600">
          ...
          <p className="mb-6 text-gray-700 leading-relaxed">
            El presente documento establece los Términos y Condiciones de Uso aplicables al sitio web, 
            operado en colaboración con el Tecnológico Nacional de México, Campus Tuxtepec, con domicilio en Calzada 
            Dr. Víctor Bravo Ahuja No. 561, Col. Predio El Paraíso, C.P. 68350, San Juan Bautista Tuxtepec, Oaxaca.
            Al acceder y utilizar este sitio web, el usuario declara haber leído, entendido y aceptado los presentes 
            Términos. Si no está de acuerdo, deberá abstenerse de usar el sitio y los servicios.
          </p>
          ...
          <p className="mb-4 text-gray-700 leading-relaxed">
            Para usar nuestros servicios, el usuario deberá tener al menos 13
