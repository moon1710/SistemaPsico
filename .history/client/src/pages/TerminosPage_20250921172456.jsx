    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 p-6">
      <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-2xl p-10">
        ...
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">
          Términos y Condiciones de Usosssss
        </h1>
        ...
        <p className="text-gray-600 mb-4">
          El tratamiento de los datos personales recabados se rige conforme a lo
          establecido en la Ley General de Protección de Datos Personales en
          Posesión de Sujetos Obligados, así como en nuestro Aviso de Privacidad,
        ...
        <p className="text-gray-600 mb-4">
          ...
          la plataforma de manera responsable. Cualquier uso indebido será motivo
          de suspensión de acceso al servicio.
        </p>
        ...
        <p className="text-gray-600 mb-4">
          El Tecnológico Nacional de México Campus Tuxtepec se reserva el derecho
          de modificar los presentes Términos y Condiciones en cualquier momento.
          Los cambios serán publicados en el sitio web.
        </p>
