...
export default function ConfidencialidadPage() {
  return (
    <div className="min-h-screen w-full m-0 p-0 bg-gradient-to-br from-indigo-200 via-pink-200 to-purple-200">
      <div className="max-w-5xl mx-auto bg-white shadow-2xl rounded-3xl p-12">
        <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-4">
          Política de Confidencialidad
        </h1>
        <p className="text-center text-gray-600 mb-10">
          En el <strong>Sistema Psicológico Integral</strong>, protegemos la
          información personal de nuestros usuarios con los más altos
          estándares de confidencialidad y seguridad.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gradient-to-tr from-indigo-100 to-purple-100 p-6 rounded-2xl shadow-md">
            ...
            <p className="text-gray-600 text-sm">
              Aplica a toda la información personal, académica o psicológica
              proporcionada dentro de la plataforma Jacaranda.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-tr from-pink-100 to-indigo-100 p-6 rounded-2xl shadow-md">
            ...
            <p className="text-gray-600 text-sm">
              Los datos serán utilizados exclusivamente para los fines
              establecidos y no se compartirán sin autorización o mandato legal.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-tr from-purple-100 to-pink-100 p-6 rounded-2xl shadow-md">
            ...
            <p className="text-gray-600 text-sm">
              Solo personal autorizado puede acceder a la información, bajo
          ...
          <div className="bg-gradient-to-tr from-indigo-100 to-pink-100 p-6 rounded-2xl shadow-md">
            ...
            <p className="text-gray-600 text-sm">
              Los datos se conservarán solo el tiempo necesario y luego serán
          ...
          <div className="bg-gradient-to-tr from-pink-100 to-purple-100 p-6 rounded-2xl shadow-md md:col-span-2">
            ...
            <p className="text-gray-600 text-sm">
              El Sistema Psicológico Integral cumple con la Ley Federal de
              Protección de Datos Personales en Posesión de los Particulares
              (LFPDPPP), garantizando la seguridad de tu información.
            </p>
          </div>
        </div>
