      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white py-12 px-6 sm:px-10 lg:px-16 rounded-xl shadow-xl border-t-4 border-indigo-600">
          ...
          <p className="mb-6 text-gray-700 leading-relaxed">
            Bienvenido a <strong>Jacaranda</strong>. Estos Términos y
            Condiciones regulan el acceso y uso de nuestro sitio web y los
            servicios que ofrecemos. Al acceder o utilizar nuestra plataforma,
            usted acepta haber leído, entendido y estar de acuerdo con lo aquí
            establecido.
          </p>
