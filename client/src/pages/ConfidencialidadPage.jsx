  ...
  return (
    <main className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 max-w-4xl bg-white shadow-xl rounded-xl">
      ...
      <p className="text-xl text-gray-600 mb-8">
        Neuroflora garantiza la protección estricta del Secreto Profesional en
        todos los servicios de atención psicológica y manejo de datos clínicos
        de los estudiantes.
      </p>
      ...
      <section id="compromiso" className="mb-10 pt-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          estándares de secreto profesional, según lo dictan los códigos de
          ética y las leyes de salud mental. La información que usted comparte
          es tratada con la máxima reserva.
        </p>
      </section>
      ...
      <section id="manejo" className="mb-10 pt-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Sus datos clínicos, notas de sesiones, y resultados de evaluaciones
          son clasificados como información sensible y se almacenan bajo cifrado
          robusto. El acceso a esta información está restringido únicamente a:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
          <li className="text-base">El estudiante (usted).</li>
          <li className="text-base">
            El psicólogo directamente a cargo de su atención.
          </li>
          <li className="text-base">
            Personal técnico, bajo supervisión y con fines de mantenimiento y
            soporte.
          </li>
        </ul>
      </section>
      ...
      <section id="alcance" className="mb-10 pt-4">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
          ...
          <li className="text-base">
            Sospecha o evidencia de abuso infantil o de adultos mayores
            vulnerables.
          </li>
          <li className="text-base">
