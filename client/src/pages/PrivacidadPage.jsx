  ...
  return (
    <main className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 max-w-4xl bg-white shadow-xl rounded-xl">
      ...
      <p className="text-sm text-gray-500 mb-8">
        El presente documento detalla la gestión de los datos personales de los
        usuarios de Neuroflora. Nuestra prioridad es su privacidad.
        <br />
      ...
      <section id="recoleccion" className="mb-10 pt-4">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
          <li className="text-base">
            Nombre completo, correo electrónico institucional y matrícula o ID
            de estudiante.
          </li>
          <li className="text-base">
            Datos demográficos (edad, género) para la correcta atención
            psicológica.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
          ...
          <li className="text-base">
            Registro de citas, historial y notas clínicas generadas por el
            psicólogo.
          </li>
        </ul>
      </section>
      ...
      <section id="finalidad" className="mb-10 pt-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Los datos se tratan con el objetivo de gestionar las citas,
          proporcionar el apoyo psicológico, personalizar recomendaciones y
          generar informes estadísticos (anonimizados) para la mejora de la
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          sensibles de salud, la necesidad de un **Tratamiento por un
          Profesional de la Salud** bajo estricta confidencialidad.
        </p>
      </section>
      ...
      <section id="seguridad" className="mb-10 pt-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Los datos se conservan durante el tiempo que sea estrictamente
          necesario para la prestación del servicio y hasta cinco (5) años
          después de que el usuario haya dejado de pertenecer a la institución
          asociada, salvo obligación legal de conservarlos por un periodo mayor.
        </p>
        <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">
          3.2. Medidas de Seguridad
        </h3>
        <p className="text-gray-700 leading-relaxed">
          Aplicamos medidas de seguridad técnicas y organizativas avanzadas,
          incluyendo cifrado de datos en tránsito y en reposo, y acceso
          restringido al historial clínico solo al personal de psicología
          asignado, para proteger la información contra el acceso no autorizado
          o la alteración.
        </p>
      </section>
      ...
      <section id="derechos" className="mb-10 pt-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          Cancelación y Oposición (Derechos ARCO) respecto a sus datos
          personales.
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
          <li className="text-base">
          ...
          <li className="text-base">
            **Cancelación:** Solicitar la eliminación de sus datos de nuestros
            registros.
          </li>
          <li className="text-base">
        ...
        <p className="text-gray-700 mt-4 leading-relaxed">
          Para ejercer estos derechos, debe contactar a nuestro Delegado de
          Protección de Datos (DPO) en la dirección indicada en la siguiente
          sección.
        </p>
      </section>
      ...
      <section id="contacto" className="mb-10 pt-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          ejercer sus Derechos ARCO, puede contactar a nuestro Delegado de
