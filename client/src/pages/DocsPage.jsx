...
import { BookOpenIcon, ClockIcon, ArrowDownTrayIcon, UserIcon, WrenchScrewdriverIcon, ChartBarIcon } from '@heroicons/react/24/outline';
...
const DocCard = ({ doc }) => {
    ...
    return (
        <div 
            ...
            ${isAvailable ? 'bg-white hover:border-indigo-400' : 'bg-gray-50 border-gray-200 opacity-70 cursor-default'}`}
        >
            <div className="flex items-start justify-between mb-3">
                <div className="flex items-center space-x-3">
                    <DocIcon iconType={doc.icon} />
                    <h3 className={`text-xl font-bold ${isAvailable ? 'text-gray-800' : 'text-gray-600'}`}>
                        {doc.title}
                    </h3>
                </div>
    ...
    return (
        <main className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <p className="text-xl text-gray-600 mb-10">
                Consulta los manuales y guías detalladas para aprovechar al máximo las funcionalidades de Neuroflora.
            </p>
            ...
            <div className="mt-12 p-6 bg-yellow-50 border-l-4 border-yellow-500 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">
                    Si no encuentras el manual que buscas, contacta a soporte para solicitar
                    capacitación personalizada o reportar una necesidad de documentación.
                </p>
                <a 
